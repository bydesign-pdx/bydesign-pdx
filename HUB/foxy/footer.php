	...
	<div id="footer-area">
		<div class="container">
          ...
          if ( 'on' == et_get_option( 'foxy_show_linkedin_icon', 'on' ) ) $social_icons['linkedin'] = array( 'image' => $template_directory_uri . '/images/linkedin.png', 'url' => et_get_option( 'foxy_linkedin_url' ), 'alt' => __( 'LinkedIn', 'foxy' ) );
          
          
          if ( 'on' == et_get_option( 'foxy_show_mortgagemapp_icon', 'on' ) ) $social_icons['mortgagemapp'] = array( 'image' => $template_directory_uri . '/images/mortgagemapp.png', 'url' => et_get_option( 'foxy_mortgagemapp_url' ), 'alt' => __( 'MortgageMapp', 'foxy' ) );
	...
	<div id="footer-bottom-area" class="container">
		<p id="copyright"><?php printf( __( 'Designed by %1$s | Powered by %2$s', 'Foxy' ), '<a href="http://www.elegantthemes.com" title="Premium WordPress Themes">Elegant Themes</a>', '<a href="http://www.wordpress.org">WordPress</a>' ); ?></p>
	</div>

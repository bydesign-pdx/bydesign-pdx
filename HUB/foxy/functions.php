...
function et_foxy_load_scripts_styles(){
	...
	wp_enqueue_script( 'cycle_script', $template_dir . '/js/jquery.cycle.min.js', array( 'jquery' ), '1.0', true );
...
function et_add_mobile_navigation(){
	echo '<div id="et_mobile_nav_menu">' . '<a href="#" class="mobile_nav closed">' . esc_html__( 'Navigation Menu', 'Foxy' ) . '</a>' . '</div>';
}
...
if ( function_exists( 'get_custom_header' ) ) {
  ...
  .footer-widget #tab-nav li.ui-state-default,
  #MLCalcForm INPUT.sbmButton {
    background:<?php echo esc_html( et_get_option( 'button_shadow', '#d9531f' ) ); ?>!important;
    
    }
    .footer-widget #tab-nav li.ui-state-active a {
  color:<?php echo esc_html( et_get_option( 'button_shadow', '#d9531f' ) ); ?>!important;
    }
    .footer-widget #tab-nav li.ui-state-active {

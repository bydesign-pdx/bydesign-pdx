...
$options = array (
	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => esc_html__("Show Google Plus Icon",$themename),
                   "id" => $shortname."_show_google_icon",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => esc_html__("Here you can choose to display your Google Plus Icon. ",$themename)
			),
			...
			array( "name" => esc_html__("Google Plus Url",$themename),
                   "id" => $shortname."_google_url",
                   "std" => "",
                   "type" => "text",
				   "desc" => esc_html__("Place your Google Plus URL here. ",$themename),
				   "validation_type" => "url"
			),
      ...
      array( "name" => esc_html__("LinkedIn Profile Url",$themename),
                   ...
                   "std" => "",
                   "type" => "text",
				   "desc" => esc_html__("Place your LinkedIn Profile URL here. ",$themename),
				   "validation_type" => "url"
			),
      
       array( "name" => esc_html__("MortgageMapp  Url",$themename),
                   "id" => $shortname."_mortgagemapp_url",
                   "std" => "",
                   "type" => "text",
				   "desc" => esc_html__("Place MortgageMapp URL here. ",$themename),
				   "validation_type" => "url"
			),
		...
		array( "name" => "general-2",
			...
			array( "name" => esc_html__("Display Products Slider",$themename),
                   "id" => $shortname."_home_products_featured",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => esc_html__("Here you can choose to display the Products Slider on the homepage. ",$themename)
			),

			array( "type" => "clearfix",),

			array( "name" => esc_html__("Display Pages in Tabs Area",$themename),
                   "id" => $shortname."_show_homepage_tabs",
                   "type" => "checkbox",
                   "std" => "on",
			...
			array( "name" => esc_html__("Display Callout",$themename),
                   "id" => $shortname."_display_callout",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => esc_html__("Here you can choose to display Callout button on the homepage. ",$themename)
			),
			...
			array( "name" => esc_html__("Callout Url",$themename),
                   "id" => $shortname."_callout_url",
                   "std" => "#",
                   "type" => "text",
				   "desc" => esc_html__("Place your Callout button URL here. ",$themename),
				   "validation_type" => "url"
			),

			array( "name" => esc_html__("Callout Text",$themename),
                   "id" => $shortname."_callout_text",
                   "std" => "Found out why everyone is talking about the <span>Foxy Theme</span>",
                   "type" => "text",
				   "desc" => esc_html__("Place your Callout text here. ",$themename),
			),

			array( "name" => esc_html__("Callout Button Text",$themename),
                   "id" => $shortname."_callout_button_text",
                   "std" => "Signup Today!",
                   "type" => "text",
				   "desc" => esc_html__("Place your Callout button Text here. ",$themename),
				   'validation_type' => 'nohtml'
			),

			array( "name" => esc_html__("Number of Featured Products",$themename),
				   "id" => $shortname."_sale_products_number",
				   "std" => "8",
				   "type" => "text",
				   "desc" => esc_html__("Here you can designate how many featured products are displayed on the homepage.",$themename),
				   "validation_type" => "number"
			),

			array( "name" => esc_html__("Include pages in the Tabs Area",$themename),
				   "id" => $shortname."_home_tabs_pages",
				   "type" => "checkboxes",
				   "std" => '',

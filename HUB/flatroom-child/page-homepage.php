	...
	<div id="primary" class="container">
        ...
        <div id="search-form">
          <form id="searchform" method="get" action="/">
             <p><input class="agent-search" type="text" name="s" size="15" />
             <input class="btn-go" type="submit" value="GO" /></p>
         </form>
         <p class="white-button"><a href="/newsletter">Sign Up</a></p>
         <p><a href="mailto:email@address.com">email@address.com</a></p>
       </div>

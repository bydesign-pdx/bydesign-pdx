		...
		<div class="row">
			<div class="span4">
				<ul class="nav nav-tabs">
					<li class="active"><a href="#login" data-toggle="tab"><?php _e( 'Login', 'flatroom' ); ?></a></li>
					<li><a href="#register" data-toggle="tab"><?php _e( 'Register', 'flatroom' ); ?></a></li>
				</ul><!-- .nav -->
              ...
              <input type="hidden" name="redirect_to" value="<?php echo esc_url( home_url( $redirect_to ) ); ?>">
							<input type="text" id="inputLoginLogin" class="input-block-level" name="log" placeholder="Login *">

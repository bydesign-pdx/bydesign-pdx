<section class="p-item p-item-full span12"><?php
	if(rwmb_meta('moutheme_embed') == ""){ ?>	
		<div id="portfolio-slider" class="flexslider"><?php

		    $images = rwmb_meta( 'moutheme_screenshot', 'type=image&size=portfolio-full' );
...
<section class="p-item-description span12"><?php the_content(); ?>
</section>
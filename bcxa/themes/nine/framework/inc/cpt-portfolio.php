...
function portfolio_register() {  
	...
	$labels = array(
		'name' => __( 'Portfolio', 'moutheme-framework' ),
		'singular_name' => __( 'Portfolio Item', 'moutheme-framework' ),
		'add_new' => __( 'Add New Item', 'moutheme-framework' ),
		'add_new_item' => __( 'Add New Portfolio Item', 'moutheme-framework' ),
		'edit_item' => __( 'Edit Portfolio Item', 'moutheme-framework' ),
		'new_item' => __( 'Add New Portfolio Item', 'moutheme-framework' ),
		'view_item' => __( 'View Item', 'moutheme-framework' ),
		'search_items' => __( 'Search Portfolio', 'moutheme-framework' ),
		'not_found' => __( 'No portfolio items found', 'moutheme-framework' ),
		'not_found_in_trash' => __( 'No portfolio items found in trash', 'moutheme-framework' )
	);
...
function portfolio_edit_columns( $portfolio_columns ) {
	$portfolio_columns = array(
		...
		"title" => _x('Title', 'column name', 'moutheme'),
		"thumbnail" => __('Thumbnail', 'moutheme'),
		"portfolio_filter" => __('Filter', 'moutheme'),
		"author" => __('Author', 'moutheme'),
		"comments" => __('Comments', 'moutheme'),
		"date" => __('Date', 'moutheme'),
	);

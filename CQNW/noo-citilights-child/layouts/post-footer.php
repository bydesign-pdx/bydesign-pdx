...
<?php if(is_singular()):?>
	...
	<footer class="content-footer">
		...
		<div id="author-bio">
			...
			<span><?php _e('About Author', NOO_TEXT_DOMAIN); ?></span>
				<h4>
					<a title="<?php printf( __( 'Post by %s',NOO_TEXT_DOMAIN), get_the_author() ); ?>" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" rel="author">

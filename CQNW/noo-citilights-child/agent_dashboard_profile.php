		...
		<div class="row">
			...
			<div class="<?php noo_main_class(); ?>" role="main">   
				<div class="submit-header">
					<h1 class="page-title"><?php _e('My Profile', NOO_TEXT_DOMAIN); ?></h1>
				</div>
				<div class="submit-content">
					<form id="profile_form" name="profile_form" class="noo-form profile-form" role="form">
						<div class="noo-control-group">
							<div class="group-title">
								<?php echo sprintf( __('Welcome back, %s', NOO_TEXT_DOMAIN), $title ); ?>
							</div>
							<div class="group-container row">
								...
								<div class="col-md-12">
									<div class="form-group s-profile-title">
										<label for="title"><?php _e('Name',NOO_TEXT_DOMAIN); ?>&nbsp;*</label>
						...
						<div class="noo-control-group">
							<div class="group-title">
								<?php _e('Social Network', NOO_TEXT_DOMAIN); ?>
							</div>
							<div class="group-container row">
								<div class="col-md-6">
									<div class="form-group s-profile-facebook">
										<label for="facebook"><?php _e('Facebook Url',NOO_TEXT_DOMAIN); ?></label>
									...
									<div class="form-group s-profile-twitter">
										<label for="twitter"><?php _e('Twitter Url',NOO_TEXT_DOMAIN); ?></label>
									...
									<div class="form-group s-profile-google_plus">
										<label for="google_plus"><?php _e('Google Plus Url',NOO_TEXT_DOMAIN); ?></label>
								...
								<div class="col-md-6">
									<div class="form-group s-profile-linkedin">
										<label for="linkedin"><?php _e('LinkedIn Url',NOO_TEXT_DOMAIN); ?></label>
									...
									<div class="form-group s-profile-pinterest">
										<label for="pinterest"><?php _e('Pinterest Url',NOO_TEXT_DOMAIN); ?></label>
										<input type="text" id="pinterest" class="form-control" value="<?php echo $pinterest; ?>" name="pinterest" />
									</div>
								</div>
								<div class="col-md-12">
									<div class="noo-submit">
										<input type="submit" class="btn btn-primary btn-lg" id="profile_submit" value="<?php _e('Update', NOO_TEXT_DOMAIN); ?>" />
									</div>
								</div>
							</div>
						</div>
					...
					<form id="password_form" name="password_form" class="noo-form profile-form" role="form">
						<div class="noo-control-group">
							<div class="group-title">
								<?php _e('Change Password', NOO_TEXT_DOMAIN); ?>
							</div>
							<div class="group-container row">
								<div class="form-message">
								</div>

...
<div id="noo-shortcodes-form-wrapper">
  <form id="noo-shortcodes-form" name="noo-shortcodes-form" method="post" action="">
    <div class="noo-form-body">
      ...
      <div class="noo-form-group">
        <label for="alt"><?php _e('Alt Text', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="text" name="alt" id="alt" />
        </div>
      </div>
      <div class="noo-form-group">
        <label for="style"><?php _e('Image Style', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
      ...
      <div class="noo-form-group">
        <label for="href"><?php _e('Image Link', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="text" name="href" id="href" class="parent-control" />
          <small class="noo-control-desc"><?php _e( 'Input the URL if you want the image to wrap inside an anchor.', NOO_TEXT_DOMAIN ); ?></small>    
        </div>
      ...
      <div class="noo-form-group href-child" style="display:none;">
        <label for="link_title"><?php _e('Image Title', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">

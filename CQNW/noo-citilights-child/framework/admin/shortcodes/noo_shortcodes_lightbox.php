  ...
  <form id="noo-shortcodes-form" name="noo-shortcodes-form" method="post" action="">
    <div class="noo-form-body">
      <div class="noo-form-group">
        <label for="gallery_id"><?php _e('Gallery ID', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="text" id="gallery_id" name="gallery_id"/>
          <small class="noo-control-desc"><?php _e('Lightbox elements with the same Gallery ID will be grouped to in the same slider lightbox.', NOO_TEXT_DOMAIN); ?></small>
        </div>
      </div>
      <hr>
      <div class="noo-form-group">
        ...
        <div class="noo-control">
          <select name="type" id="type">
            <option value="image" selected="true"><?php _e('Image', NOO_TEXT_DOMAIN); ?></option>
            <option value="iframe"><?php _e('IFrame', NOO_TEXT_DOMAIN); ?></option>
            <option value="inline"><?php _e('HTML Content', NOO_TEXT_DOMAIN); ?></option>
          </select>
        </div>
      </div>
      ...
      <div class="noo-form-group type-image-child">
        <label for="image_title"><?php _e('Image Title', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="text" id="image_title" name="image_title"/>
        </div>
      </div> 
      <div class="noo-form-group type-iframe-child" style="display:none;">
        <label for="iframe_url"><?php _e('Iframe URL', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="text" id="iframe_url" name="iframe_url"/>
          <small class="noo-control-desc"><?php _e('You can input any link like http://wikipedia.com. Youtube and Vimeo link will be converted to embed video, other video site will need embeded link.', NOO_TEXT_DOMAIN); ?></small>
        </div>
      </div>
      <div class="noo-form-group type-inline-child" style="display:none;">
        <label for="inline"><?php _e('HTML Content', NOO_TEXT_DOMAIN); ?></label>
        <?php
      ...
      <hr>
      <div class="noo-form-group">
        <label for="thumbnail_type"><?php _e('Thumbnail Type', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
      ...
      <div class="noo-form-group thumbnail_type-image-child">
        <label for="thumbnail_image"><?php _e('Thumbnail Image', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input id="thumbnail_image" type="text" name="thumbnail_image" class="noo-wpmedia parent-control" value=""/>
          <small class="noo-control-desc"><?php _e('For image Lightbox, thumbnail of original image is automatically created if you do not choose any thumbnail.', NOO_TEXT_DOMAIN); ?></small>
      ...
      <div class="noo-form-group thumbnail_type-image-child">
        <label for="thumbnail_style"><?php _e('Thumbnail style', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <select name="thumbnail_style" id="thumbnail_style">
            <option value=""><?php _e('None', NOO_TEXT_DOMAIN); ?></option>
            <option value="rounded" selected="true"><?php _e('Rounded', NOO_TEXT_DOMAIN); ?></option>
            <option value="circle"><?php _e('Circle', NOO_TEXT_DOMAIN); ?></option>
            <option value="thumbnail"><?php _e('Thumbnail', NOO_TEXT_DOMAIN); ?></option>
          </select>
        </div>
      </div>
      <div class="noo-form-group thumbnail_type-link-child" style="display:none;">
        <label for="thumbnail_title"><?php _e('Thumbnail Title', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">

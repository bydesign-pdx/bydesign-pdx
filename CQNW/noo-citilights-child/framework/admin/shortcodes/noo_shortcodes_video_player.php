  ...
  <form id="noo-shortcodes-form" name="noo-shortcodes-form" method="post" action="">
    <div class="noo-form-body">
      <div class="noo-form-group">
        <label for="video_m4v"><?php _e('M4V File URL', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="text" name="video_m4v" id="video_m4v" />
          <small class="noo-control-desc"><?php _e('Place the URL to your .m4v video file here.', NOO_TEXT_DOMAIN); ?></small>
        </div>
      </div>
      <div class="noo-form-group">
        <label for="video_ogv"><?php _e('OGV File URL', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="text" name="video_ogv" id="video_ogv" />
          <small class="noo-control-desc"><?php _e('Place the URL to your .ogv video file here.', NOO_TEXT_DOMAIN); ?></small>
        </div>
      </div>
      <div class="noo-form-group">
      ...
      <div class="noo-form-group">
        <label for="video_poster"><?php _e('Poster Image', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
      ...
      <div class="noo-form-group">
        <label for="auto_play"><?php _e('Auto Play Video', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
      ...
      <hr>
      <div class="noo-form-group">
        <label for="hide_controls"><?php _e('Hide Player Controls', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input name="hide_controls" id="hide_controls" type="checkbox" />
        </div>
      </div>
      <div class="noo-form-group">
        <label for="show_play_icon"><?php _e('Show Play Icon', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">

...
<div id="noo-shortcodes-form-wrapper">
  <form id="noo-shortcodes-form" name="noo-shortcodes-form" method="post" action="">
    <div class="noo-form-body">
      ...
      <div class="noo-form-group">
        <label for="featured"><?php _e('Featured', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
      ...
      <hr>
      <div class="noo-form-group">
        <label for="price"><?php _e('Price', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="text" name="price" id="price" />
        </div>
      </div>
      <div class="noo-form-group">
        <label for="symbol"><?php _e('Currency Symbol', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="text" name="symbol" id="symbol" value="$" />
        </div>
      </div>
      <div class="noo-form-group">
        <label for="before_price"><?php _e('Text Before Price', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="text" name="before_price" id="before_price" value="<?php _e('From', NOO_TEXT_DOMAIN); ?>" />
        </div>
      </div>
      <div class="noo-form-group">
        <label for="after_price"><?php _e('Text After Price', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="text" name="after_price" id="after_price" value="<?php _e('per Month', NOO_TEXT_DOMAIN); ?>" />
        </div>
      </div>
      <hr>
      <div class="noo-form-group">
        <label for="pricing_item"><?php _e('Text', NOO_TEXT_DOMAIN); ?></label>
        <?php
      ...
      <hr>
      <div class="noo-form-group">
        <label for="button_text"><?php _e('Button Text', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
      ...
      <div class="noo-form-group">
        <label for="size"><?php _e('Button Size', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <select name="size" id="size">
            <option value="x_small"><?php _e('Extra Small', NOO_TEXT_DOMAIN); ?></option>
            <option value="small"><?php _e('Small', NOO_TEXT_DOMAIN); ?></option>
            <option value="medium" selected="true"><?php _e('Medium', NOO_TEXT_DOMAIN); ?></option>
      ...
      <hr>
      <div class="noo-form-group">
        <label for="button_shape"><?php _e('Button Shape', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
      ...
      <div class="noo-form-group">
        <label for="button_style"><?php _e('Button Style', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
      ...
      <div class="noo-form-group">
        <label for="skin"><?php _e('Button Skin', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">

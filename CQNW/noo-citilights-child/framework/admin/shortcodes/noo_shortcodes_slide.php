...
<div id="noo-shortcodes-form-wrapper">
  <form id="noo-shortcodes-form" name="noo-shortcodes-form" method="post" action="">
    <div class="noo-form-body">
      <div class="noo-form-group">
        ...
        <div class="noo-control">
          <select name="type" id="type">
            ...
            <!-- <option value="video"><?php _e('Video', NOO_TEXT_DOMAIN); ?></option> -->
            <option value="content"><?php _e('HTML Content', NOO_TEXT_DOMAIN); ?></option>
          </select>
        </div>
      </div>
      ...
      <div class="noo-form-group type-image-child">
        <label for="caption"><?php _e('Caption', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <textarea id="caption" name="caption"></textarea>
        </div>
      </div> 
      <!-- <div class="noo-form-group type-video-child" style="display:none;">
        <label for="video_url"><?php _e('Video URL', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="text" id="video_url" name="video_url"/>
        </div>
      </div>
      <div class="noo-form-group type-video-child" style="display:none;">
        <label for="video_poster"><?php _e('Video Poster Image', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
      ...
      <div class="noo-form-group type-content-child" style="display:none;">
        <label for="content"><?php _e('HTML Content', NOO_TEXT_DOMAIN); ?></label>
        <?php

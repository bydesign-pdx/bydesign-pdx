...
<div id="noo-shortcodes-form-wrapper">
  <form id="noo-shortcodes-form" name="noo-shortcodes-form" method="post" action="">
    <div class="noo-form-body">
      ...
      <div class="noo-form-group">
        <label for="tab_count"><?php _e('Number of Tabs', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="text" id="tab_count" name="tab_count" class="noo-slider" value="3" data-min="1" data-max="20"/>
        </div>
      </div>
      <div class="noo-form-group">
        <label for="active_tab"><?php _e('Active Tab', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="text" name="active_tab" id="active_tab" />
          <small class="noo-control-desc"><?php _e('The tab number to be active on load, default is 1. Enter -1 to collapse all tabs.', NOO_TEXT_DOMAIN); ?></small>
        </div>
      </div>
      <div class="noo-form-group">
        <label for="icon_style"><?php _e('Icon Style', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <select name="icon_style" id="icon_style">
            <option value="dark_circe" selected="true"><?php _e('Dark Circle', NOO_TEXT_DOMAIN); ?></option>
            <option value="light_circe"><?php _e('Light Circle', NOO_TEXT_DOMAIN); ?></option>
            <option value="dark_square"><?php _e('Dark Square', NOO_TEXT_DOMAIN); ?></option>
            <option value="light_square"><?php _e('Light Square', NOO_TEXT_DOMAIN); ?></option>
            <option value="simple"><?php _e('Simple Icon', NOO_TEXT_DOMAIN); ?></option>
            <option value="left_arrow"><?php _e('Left Arrow', NOO_TEXT_DOMAIN); ?></option>
            <option value="right_arrow"><?php _e('Right Arrow', NOO_TEXT_DOMAIN); ?></option>
          </select>
        </div>
      </div>
      <hr>

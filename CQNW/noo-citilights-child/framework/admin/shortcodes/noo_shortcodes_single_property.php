...
<div id="noo-shortcodes-form-wrapper">
  <form id="noo-shortcodes-form" name="noo-shortcodes-form" method="post" action="">
    <div class="noo-form-body">
      ...
      <div class="noo-form-group">
        <label for="property_id"><?php _e('Property ID', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="text" id="property_id" name="property_id" />
          <small class="noo-control-desc"><?php _e( 'Input the ID of the property you want to show.', NOO_TEXT_DOMAIN ); ?></small>
        </div>
      </div>
      <div class="noo-form-group">
        ...
        <div class="noo-control">
          <select name="style" id="style">
            <option value="featured" selected="true"><?php _e('Featured Style', NOO_TEXT_DOMAIN); ?></option>
            <option value="list"><?php _e('List', NOO_TEXT_DOMAIN); ?></option>
            <option value="grid"><?php _e('Grid', NOO_TEXT_DOMAIN); ?></option>
          </select>
        </div>
      </div>
      <hr>

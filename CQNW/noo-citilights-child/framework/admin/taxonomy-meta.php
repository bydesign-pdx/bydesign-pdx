...
function noo_taxonomy_add_new_meta_field() {
	...
	<div class="form-field">
		<label for="term_meta-enable-heading"><?php _e( 'Show Headline', NOO_TEXT_DOMAIN ); ?></label>
		...
		<p class="description"><?php _e( 'Enable Headline when viewing this taxonomy page.', NOO_TEXT_DOMAIN ); ?></p>
	</div>
	<div class="form-field term_meta-enable-heading-child">
		<label for="term_meta-heading-image"><?php _e( 'Headline Background Image', NOO_TEXT_DOMAIN ); ?></label>
		<input type="hidden" name="term_meta[heading-image]" id="term_meta-heading-image" value="" />
		<input type="button" class="button button-primary" name="term_meta-heading-image_button_upload" id="term_meta-heading-image_button_upload" value="<?php _e( 'Select Image', NOO_TEXT_DOMAIN ); ?>" />
		<input type="button" class="button" name="term_meta-heading-image_button_clear" id="term_meta-heading-image_button_clear" value="<?php _e( 'Clear Image', NOO_TEXT_DOMAIN ); ?>" style="display: none;"/>
		<div class="noo-thumb-wrapper"></div>
		<p class="description"><?php _e( 'If you leave it blank, it will use the image set on Customizer setting for Index page.', NOO_TEXT_DOMAIN ); ?></p>
		<script>
			jQuery(document).ready(function($) {
				$('#term_meta-heading-image_button_upload').on('click', function(event) {
					...
					var wp_media_frame = wp.media.frames.wp_media_frame = wp.media({
						title: "<?php echo __( 'Select or Upload your Image', NOO_TEXT_DOMAIN ); ?>",
						button: {
							text: "<?php echo __( 'Select', NOO_TEXT_DOMAIN ); ?>"
						},
						library: { type: 'image' },
						multiple: false
					});
					...
					wp_media_frame.on('select', function(){
						...
						noo_upload_btn.attr('value', '<?php echo __( 'Change Image', NOO_TEXT_DOMAIN ); ?>');
				...
				$('#term_meta-heading-image_button_clear').on('click', function(event) {
					...
					noo_clear_btn.hide();
					$('#term_meta-heading-image_button_upload').attr('value', '<?php echo __( 'Select Image', NOO_TEXT_DOMAIN ); ?>');
	...
	<div class="form-field term_meta-enable-heading-child">
		<label for="term_meta[heading-title]"><?php _e( 'Headline Title', NOO_TEXT_DOMAIN ); ?></label>
		<input type="text" name="term_meta[heading-title]" id="term_meta[heading-title]" value="">
		<p class="description"><?php _e( 'This Title is used to display on the Headline.',NOO_TEXT_DOMAIN ); ?></p>
	</div>
	<div class="form-field term_meta-enable-heading-child">
		<label for="term_meta[heading-sub-title]"><?php _e( 'Headline Sub-Title', NOO_TEXT_DOMAIN ); ?></label>
		<textarea type="" name="term_meta[heading-sub-title]" id="term_meta[heading-sub-title]" value="" row="5" col="40"></textarea>
		<p class="description"><?php _e( 'This Sub-Title is used to display below Title on the Headline.', NOO_TEXT_DOMAIN ); ?></p>
	</div>
	<?php
}
...
function noo_taxonomy_edit_meta_field($term) {
	...
	<hr/>
	<tr class="form-field">
		<th scope="row" valign="top"><label for="term_meta-enable-heading"><?php _e( 'Show Headline', NOO_TEXT_DOMAIN ); ?></label></th>
		<td>
			<input type="hidden" name="term_meta[enable-heading]" value="0" >
	...
	<tr class="form-field term_meta-enable-heading-child" <?php echo ( $enable ) ? '' : 'style="display: none;"'; ?> >
		<th scope="row" valign="top"><label for="term_meta-heading-image"><?php _e( 'Headline Background Image', NOO_TEXT_DOMAIN ); ?></label></th>
		<td>
			<?php
				...
				$btn_text = !empty( $image_id ) ? __( 'Change Image', NOO_TEXT_DOMAIN ) : __( 'Select Image', NOO_TEXT_DOMAIN );
			?>
			...
			<input type="button" class="button" name="term_meta-heading-image_button_clear" id="term_meta-heading-image_button_clear" value="<?php _e( 'Clear Image', NOO_TEXT_DOMAIN ); ?>" <?php echo ( $image_id ) ? '' : 'style="display: none;"' ?> />
	...
	<tr class="form-field term_meta-enable-heading-child" <?php echo ( $enable ) ? '' : 'style="display: none;"'; ?> >
		<th scope="row" valign="top"><label for="term_meta[heading-title]"><?php _e( 'Headline Title', NOO_TEXT_DOMAIN ); ?></label></th>
		<td>
			...
			<p class="description"><?php _e( 'This Title is used to display on the Headline. If you leave it blank, the Title will be used.', NOO_TEXT_DOMAIN ); ?></p>
		</td>
	</tr>
	<tr class="form-field term_meta-enable-heading-child" <?php echo ( $enable ) ? '' : 'style="display: none;"'; ?> >
		<th scope="row" valign="top"><label for="term_meta[heading-sub-title]"><?php _e( 'Headline Sub Title', NOO_TEXT_DOMAIN ); ?></label></th>
		<td>

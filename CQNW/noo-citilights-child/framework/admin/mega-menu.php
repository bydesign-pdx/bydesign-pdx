			...
			if( $firstlevel ) {
				...
				<p class="noo-mega-menu-enable description description-wide">
					<label>
						...
						<?php _e( 'Enable Mega Menu', NOO_TEXT_DOMAIN ) ?>
					</label>
				</p>
				<p class="noo-mega-menu-columns description description-wide megamenu-child-options" style="display: <?php echo $noo_mega_menu_enable ? 'block' : 'none' ?>">
					<label for="menu-item-noo-mega-menu-columns-<?php echo $item->ID; ?>">
						<?php echo ( $is_vertical_menu ? __( 'Number of Rows', NOO_TEXT_DOMAIN ) : __( 'Number of Columns', NOO_TEXT_DOMAIN ) ); ?>
						<br/>
						<select id="menu-item-noo-mega-menu-columns-<?php echo $item->ID; ?>" name="menu-item-noo-mega-menu-columns[<?php echo $item->ID; ?>]" class="noo-mega-menu-columns">
							<option <?php selected( 'columns-2', $noo_mega_menu_columns ) ?> value="columns-2"><?php _e( 'Two', NOO_TEXT_DOMAIN ) ?></option>
							<option <?php selected( 'columns-3', $noo_mega_menu_columns ) ?> value="columns-3"><?php _e( 'Three', NOO_TEXT_DOMAIN ) ?></option>
							<option <?php selected( 'columns-4', $noo_mega_menu_columns ) ?> value="columns-4"><?php _e( 'Four', NOO_TEXT_DOMAIN ) ?></option>
							<option <?php selected( 'columns-5', $noo_mega_menu_columns ) ?> value="columns-5"><?php _e( 'Five', NOO_TEXT_DOMAIN ) ?></option>
							<option <?php selected( 'columns-6', $noo_mega_menu_columns ) ?> value="columns-6"><?php _e( 'Six', NOO_TEXT_DOMAIN ) ?></option>
						</select>
					</label>
				</p>
				...
				<p class="noo-submenu-alignment description description-wide">
					<label for="menu-item-noo-submenu-alignment-<?php echo $item->ID; ?>">
						<?php _e( 'Sub-Menu Alignment', NOO_TEXT_DOMAIN ); ?>
						<br/>
						<select id="menu-item-noo-submenu-alignment-<?php echo $item->ID; ?>" name="menu-item-noo-submenu-alignment[<?php echo $item->ID; ?>]">
							<option <?php selected( 'full-width', $noo_submenu_alignment ) ?> value="full-width" class="megamenu-child-options" style="display: <?php echo $noo_mega_menu_enable ? 'inline' : 'none' ?>;"><?php _e( 'Full-width', NOO_TEXT_DOMAIN ); ?></option>
							<option <?php selected( 'align-left', $noo_submenu_alignment ) ?> value="align-left"><?php _e( 'Align Left', NOO_TEXT_DOMAIN ) ?></option>
							<option <?php selected( 'align-right', $noo_submenu_alignment ) ?> value="align-right"><?php _e( 'Align Right', NOO_TEXT_DOMAIN ) ?></option>
							<option <?php selected( 'align-center', $noo_submenu_alignment ) ?> value="align-center"><?php _e( 'Align Center', NOO_TEXT_DOMAIN ) ?></option>
						</select>
					</label>
				</p>
				<?php else: ?>
				<p class="noo-mega-menu-fullheight description description-wide" class="megamenu-child-options" style="display: <?php echo $noo_mega_menu_enable ? 'block' : 'none' ?>">
					<label>
						...
						<?php _e( 'Full-height Mega Menu', NOO_TEXT_DOMAIN ); ?>
					</label>
				</p>
				<?php endif; ?>
				<p class="noo-menu-visibility description description-wide">
					<label for="menu-item-noo-menu-visibility-<?php echo $item->ID; ?>">
						<?php _e( 'Visibility', NOO_TEXT_DOMAIN ); ?>
						<br/>
						<select id="menu-item-noo-menu-visibility-<?php echo $item->ID; ?>" name="menu-item-noo-menu-visibility[<?php echo $item->ID; ?>]">
							<option <?php selected( '', $noo_menu_visibility ) ?> value="" ><?php _e('All Devices', NOO_TEXT_DOMAIN); ?></option>
							<option <?php selected( 'hidden-phone', $noo_menu_visibility ) ?> value="hidden-phone"><?php _e('Hidden Phone', NOO_TEXT_DOMAIN); ?></option>
							<option <?php selected( 'hidden-tablet', $noo_menu_visibility ) ?> value="hidden-tablet"><?php _e('Hidden Tablet', NOO_TEXT_DOMAIN); ?></option>
							<option <?php selected( 'hidden-pc', $noo_menu_visibility ) ?> value="hidden-pc"><?php _e('Hidden PC', NOO_TEXT_DOMAIN); ?></option>
							<option <?php selected( 'visible-phone', $noo_menu_visibility ) ?> value="visible-phone"><?php _e('Visible Phone', NOO_TEXT_DOMAIN); ?></option>
							<option <?php selected( 'visible-tablet', $noo_menu_visibility ) ?> value="visible-tablet"><?php _e('Visible Tablet', NOO_TEXT_DOMAIN); ?></option>
							<option <?php selected( 'visible-pc', $noo_menu_visibility ) ?> value="visible-pc"><?php _e('Visible PC', NOO_TEXT_DOMAIN); ?></option>
						</select>
					</label>
				</p>
				...
				<p class="noo-submenu-direction description description-wide">
					<label for="menu-item-noo-submenu-direction-<?php echo $item->ID; ?>">
						<?php _e( 'Flying Direction for Sub-Menu of this Item', NOO_TEXT_DOMAIN ); ?>
						<br/>
						<select id="menu-item-noo-submenu-direction-<?php echo $item->ID; ?>" name="menu-item-noo-submenu-direction[<?php echo $item->ID; ?>]">
							<option <?php selected( 'fly-left', $noo_submenu_direction ) ?> value="fly-left"><?php _e( 'Fly Left', NOO_TEXT_DOMAIN ) ?></option>
							<option <?php selected( 'fly-right', $noo_submenu_direction ) ?> value="fly-right"><?php _e( 'Fly Right', NOO_TEXT_DOMAIN ) ?></option>
						</select>
					</label>
				</p>
				<?php endif; ?>

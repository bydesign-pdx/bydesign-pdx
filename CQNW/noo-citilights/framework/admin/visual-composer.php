		...
		function noo_vc_citilights() {
				...
				array (
					...
					'params' => array (
						...
						array (
							...
							'heading' => __( 'Property Status', NOO_TEXT_DOMAIN ),
							'type' => 'dropdown',
							'description'=>__('Select a status',NOO_TEXT_DOMAIN),
							'admin_label'=>true,
							'holder' => $param_holder,
			...
			$advanced_search_params = array (
				...
				array (
						...
						'heading' => __( 'Map Height (px)', NOO_TEXT_DOMAIN ),
						'description' => __( 'The maximum height of the map', NOO_TEXT_DOMAIN ),
						'type' => 'ui_slider',
						'holder' => $param_holder,
						'value' => '700',
						'data_min' => '400',
			...
			vc_map ( array (
					...
					'params' => array (
							...
							array (
									...
									'heading' => __( 'Slider Height (px)', NOO_TEXT_DOMAIN ),
									'description' => __( 'The maximum height of the slider', NOO_TEXT_DOMAIN ),
									'type' => 'ui_slider',
									'holder' => $param_holder,
									'value' => '700',
									'data_min' => '400',
							...
							array (
								'param_name' => 'advanced_search',
									'heading' => __( 'Show Amenities Search', NOO_TEXT_DOMAIN ),
							...
							array (
								'param_name' => 'search_info_title',
									'heading' => __( 'Search Info Title', NOO_TEXT_DOMAIN ),
									'description' => __( 'The Title of Search Info box, leave it blank for no title.', NOO_TEXT_DOMAIN ),
									'type' => 'textfield',
									'holder' => $param_holder,
									'value' => '',
									'dependency' => array( 'element' => 'show_search_form', 'not_empty' => true )
							...
							array (
								'param_name' => 'search_info_content',
									'heading' => __( 'Search Info Content', NOO_TEXT_DOMAIN ),
									'description' => __( 'The Content of Search Info box, leave it blank for no content.', NOO_TEXT_DOMAIN ),
									'type' => 'textfield',
									'holder' => $param_holder,
									'value' => '',
									'dependency' => array( 'element' => 'show_search_form', 'not_empty' => true )
				...
				array(
					...
					'params'          => array(
						...
						array(
							...
							'heading'		=> __( 'Hide Post Meta', NOO_TEXT_DOMAIN ),
							'type'          => 'checkbox',
							'holder'        => $param_holder,
							'value'         => array( '' => 'true' )
						),

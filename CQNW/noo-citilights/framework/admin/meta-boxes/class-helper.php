		...
		if ( !isset( $meta_box['fields'] ) || empty( $meta_box['fields'] ) ) {
			...
			case 'data-video':
				...
				$meta_box['fields'][] = array(
					...
					'desc' => __( 'If you are using something other than self hosted video (YouTube, Vimeo, etc.) paste the embed code here. This field will override the above settings.', NOO_TEXT_DOMAIN ),
					'type' => 'textarea',
					'std'  => ''
				);
				break;
			...
			case 'data-image':
				$meta_box['fields'][] = array(
					...
					'label' => __( 'Upload Image', NOO_TEXT_DOMAIN ),
					'type' => 'image',
				);
				break;

...
if ( ! function_exists( 'noo_customizer_register_options_header' ) ) :
	function noo_customizer_register_options_header( $wp_customize ) {
		...
		$helper->add_control(
			...
			'checkbox',
			__( 'Only Search Properties', NOO_TEXT_DOMAIN ),
			1,
			array(),
			array( 'transport' => 'postMessage' )
		);
...
if ( ! function_exists( 'noo_customizer_register_options_footer' ) ) :
	function noo_customizer_register_options_footer( $wp_customize ) {
		...
		$helper->add_control(
			...
			'noo_image',
			__( 'Footer Background Image', NOO_TEXT_DOMAIN ),
			'',
			array(),
			array( 'transport' => 'postMessage' )
		);
...
if ( ! function_exists( 'noo_customizer_register_options_property' ) ) :
	function noo_customizer_register_options_property( $wp_customize ) {
		...
		$helper->add_control(
			'noo_property_layout',
			'noo_radio',
			__( 'Listing Page Layout', NOO_TEXT_DOMAIN ),
			'fullwidth',
			array(
				'choices' => array(
					'fullwidth'   => __( 'Full-Width', NOO_TEXT_DOMAIN ),
		...
		$helper->add_control(
			...
			'widgets_select',
			__( 'Listing Page Sidebar', NOO_TEXT_DOMAIN ),
			'',
			array(),
			array( 'transport' => 'postMessage' )
		);
		...
		$helper->add_control(
			...
			'noo_radio',
			__( 'Listing Style', NOO_TEXT_DOMAIN ),
			'grid',
			array(
				'choices' => array(
					'grid'   => __( 'Grid Style', NOO_TEXT_DOMAIN ),
					'list'   => __( 'List Style', NOO_TEXT_DOMAIN ),
				)
			),
			array( 'transport' => 'postMessage' )
		);
		...
		$helper->add_control(
			...
			'checkbox',
			__( 'Enable Properties Sort', NOO_TEXT_DOMAIN ),
			1,
			array(),
			array( 'transport' => 'postMessage' )
		);
		...
		$helper->add_control(
			...
			'noo_switch',
			__( 'Show Property Search', NOO_TEXT_DOMAIN ),
			1,
			array(
				'json' => array(
		...
		$helper->add_control(
			...
			'noo_radio',
			__( 'Search Layout', NOO_TEXT_DOMAIN ),
			'horizontal',
			array(
				'choices' => array(
		...
		$helper->add_control(
			...
			'checkbox',
			__( 'Enable Features/Amenities Search', NOO_TEXT_DOMAIN ),
			0,
			array(),
			array( 'transport' => 'postMessage' )
		);
		...
		$helper->add_control(
			...
			'noo_same_as_radio',
			__( 'Property Page Layout', NOO_TEXT_DOMAIN ),
			'same_as_listing',
			array(
				'choices' => array(
					'same_as_listing'	=> __( 'Same as Listing Layout', NOO_TEXT_DOMAIN ),
					'fullwidth'   => __( 'Full-Width', NOO_TEXT_DOMAIN ),
					'sidebar'   => __( 'With Right Sidebar', NOO_TEXT_DOMAIN ),
					'left_sidebar'   => __( 'With Left Sidebar', NOO_TEXT_DOMAIN ),
				),
		...
		$helper->add_control(
			...
			'widgets_select',
			__( 'Property Page Sidebar', NOO_TEXT_DOMAIN ),
			'',
			array(),
			array( 'transport' => 'postMessage' )
		);
		...
		$helper->add_control(
				...
				'ui_slider',
				__( 'Number of Similar Properties', NOO_TEXT_DOMAIN ),
				'2',
				array(
					'json' => array(
						'data_min'  => '0',

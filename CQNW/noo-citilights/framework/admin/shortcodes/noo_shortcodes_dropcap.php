  ...
  <form id="noo-shortcodes-form" name="noo-shortcodes-form" method="post" action="">
    <div class="noo-form-body">
      <div class="noo-form-group">
        <label for="letter"><?php _e('Letter', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="text" name="letter" id="letter" />
        </div>
      </div>
      <div class="noo-form-group">
        <label for="color"><?php _e('Letter Color', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
      ...
      <div class="noo-form-group">
        ...
        <div class="noo-control">
          <select name="style" id="style">
            <option value="transparent" selected="true"><?php _e('Transparent', NOO_TEXT_DOMAIN); ?></option>
            <option value="square"><?php _e('Filled Square', NOO_TEXT_DOMAIN); ?></option>
            <option value="circle"><?php _e('Filled Circle', NOO_TEXT_DOMAIN); ?></option>
          </select>
        </div>
      </div>

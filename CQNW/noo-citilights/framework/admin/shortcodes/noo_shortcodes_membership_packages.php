      ...
      <div class="noo-form-group">
        ...
        <div class="noo-control">
          <select name="style" id="style">
            <option value="ascending" selected="true"><?php _e('Ascending', NOO_TEXT_DOMAIN); ?></option>
            <option value="classic"><?php _e('Classic', NOO_TEXT_DOMAIN); ?></option>
          </select>
        </div>
      </div>
      <div class="noo-form-group">
        <label for="featured_item"><?php _e('Featured Item', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="text" id="featured_item" name="featured_item" class="noo-slider" value="2" data-min="1" data-max="10"/>
          <small class="noo-control-desc"><?php _e( 'Enter the no. of the Package that is featured', NOO_TEXT_DOMAIN ); ?></small>
        </div>
      </div>
      <div class="noo-form-group">
        <label for="btn_text"><?php _e('Buttons Text', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="text" name="btn_text" id="btn_text" value="<?php _e('Sign Up', NOO_TEXT_DOMAIN); ?>"/>
        </div>
      </div>
      <hr>
      <div class="noo-form-group">

  ...
  <form id="noo-shortcodes-form" name="noo-shortcodes-form" method="post" action="">
    <div class="noo-form-body">
      <div class="noo-form-group">
        <label for="name"><?php _e('Member Name', NOO_TEXT_DOMAIN); ?></label>
      ...
      <hr>
      <div class="noo-form-group">
        <label for="avatar"><?php _e('Member Image', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
      ...
      <div class="noo-form-group">
        <label for="role"><?php _e('Job Position', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">

...
<div id="noo-shortcodes-form-wrapper">
  <form id="noo-shortcodes-form" name="noo-shortcodes-form" method="post" action="">
    <div class="noo-form-body">
      ...
      <hr>
      <div class="noo-form-group">
        <label for="icon_size"><?php _e('Icon Size (px)', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="text" id="icon_size" name="icon_size" class="noo-slider" value="0" data-min="0" data-max="60"/>
          <small class="noo-control-desc"><?php _e('Leave it empty or 0 to use the base size of your theme.', NOO_TEXT_DOMAIN); ?></small>
        </div>
        <div class="noo-control">
          <label for="text_same_size">
            <input name="text_same_size" id="text_same_size" type="checkbox" class="parent-control" checked="checked" /><?php _e('Use This Size for Text', NOO_TEXT_DOMAIN); ?>
          </label>
        </div>
      </div>
      <div class="noo-form-group text_same_size-no-child" style="display:none;" >
        <label for="text_size"><?php _e('Text Size (px)', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
      ...
      <div class="noo-form-group" >
        ...
        <div class="noo-control">
          <label for="text_same_color">
            <input name="text_same_color" id="text_same_color" type="checkbox" class="parent-control" checked="checked" /><?php _e('Use This Color for Text', NOO_TEXT_DOMAIN); ?>
          </label>
        </div>
      </div>
      ...
      <hr>
      <div class="noo-form-group">
        <label for="icontext"><?php _e('Text', NOO_TEXT_DOMAIN); ?></label>
        <?php

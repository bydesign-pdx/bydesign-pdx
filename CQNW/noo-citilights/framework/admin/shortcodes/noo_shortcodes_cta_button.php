    ...
    <div class="noo-form-body">
      ...
      <div class="noo-form-group">
        ...
        <div class="noo-control">
          ...
          <label for="fullwidth">
            <input name="fullwidth" id="fullwidth" type="checkbox" /><?php _e('Full-Width', NOO_TEXT_DOMAIN); ?>
          </label>
        </div>
      </div>
      <div class="noo-form-group size-custom-child" style="display:none;">
        <label for="vertical_padding"><?php _e('Custom Vertical Padding (px)', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="text" id="vertical_padding" name="vertical_padding" class="noo-slider" value="0" data-min="0" data-max="50"/>
        </div>
      </div>
      <div class="noo-form-group size-custom-child" style="display:none;">
        <label for="horizontal_padding"><?php _e('Custom Horizontal Padding (px)', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
      ...
      <hr>
      <div class="noo-form-group">
        <label for="icon"><?php _e('Button Icon', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
      ...
      <div class="noo-form-group skin-custom-child" style="display:none;">
        <label for="hover_text_color"><?php _e('Hover Color', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">

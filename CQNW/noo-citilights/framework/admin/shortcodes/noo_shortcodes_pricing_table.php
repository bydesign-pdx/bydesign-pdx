...
<div id="noo-shortcodes-form-wrapper">
  <form id="noo-shortcodes-form" name="noo-shortcodes-form" method="post" action="">
    <div class="noo-form-body">
      ...
      <div class="noo-form-group">
        <label for="columns"><?php _e('Number of Columns', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
      ...
      <div class="noo-form-group">
        ...
        <div class="noo-control">
          <select name="style" id="style">
            <option value="classic" selected="true"><?php _e('Classic', NOO_TEXT_DOMAIN); ?></option>
            <option value="ascending"><?php _e('Ascending', NOO_TEXT_DOMAIN); ?></option>
          </select>
        </div>
      <hr>
      <div class="noo-form-group">

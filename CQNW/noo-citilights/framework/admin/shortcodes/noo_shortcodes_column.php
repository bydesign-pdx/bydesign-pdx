  ...
  <form id="noo-shortcodes-form" name="noo-shortcodes-form" method="post" action="">
    <div class="noo-form-body">
      <div class="noo-form-group">  
        <label  class="noo-label" for="width"><strong><?php _e('Column Width', NOO_TEXT_DOMAIN); ?></strong></label>
        <div class="noo-control">
          <select name="width" id="width">
            <option value="1/1" selected="true"><?php _e('One Whole (1/1)', NOO_TEXT_DOMAIN); ?></option>
            <option value="1/2"><?php _e('One Half (1/2)', NOO_TEXT_DOMAIN); ?></option>
            <option value="1/3"><?php _e('One Third (1/3)', NOO_TEXT_DOMAIN); ?></option>
            <option value="2/3"><?php _e('Two Thirds (2/3)', NOO_TEXT_DOMAIN); ?></option>
            <option value="1/4"><?php _e('One Fourth (1/4)', NOO_TEXT_DOMAIN); ?></option>
            <option value="3/4"><?php _e('Three Fourths (3/4)', NOO_TEXT_DOMAIN); ?></option>
            <option value="1/5"><?php _e('One Fifths (1/5)', NOO_TEXT_DOMAIN); ?></option>
            <option value="2/5"><?php _e('Two Fifths (2/5)', NOO_TEXT_DOMAIN); ?></option>
            <option value="3/5"><?php _e('Three Fifths (3/5)', NOO_TEXT_DOMAIN); ?></option>
            <option value="4/5"><?php _e('Four Fifths (4/5)', NOO_TEXT_DOMAIN); ?></option>
            <option value="1/6"><?php _e('One Six (1/6)', NOO_TEXT_DOMAIN); ?></option>
            <option value="5/6"><?php _e('Five Sixs (5/6)', NOO_TEXT_DOMAIN); ?></option>
          </select>
        </div>
      </div>
      <hr>
      <div class="noo-form-group">
        <label for="alignment"><?php _e('Text Alignment', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <select name="alignment" id="alignment">
            <option value="left" selected="true"><?php _e('Left', NOO_TEXT_DOMAIN); ?></option>
      ...
      <hr>
      <div class="noo-form-group">
        <label  class="noo-label" for="visibility"><strong><?php _e('Visibility', NOO_TEXT_DOMAIN); ?></strong></label>
        <div class="noo-control">

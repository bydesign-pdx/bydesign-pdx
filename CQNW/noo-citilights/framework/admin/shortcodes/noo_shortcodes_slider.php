  ...
  <form id="noo-shortcodes-form" name="noo-shortcodes-form" method="post" action="">
    <div class="noo-form-body">
      <div class="noo-form-group">
        <label for="animation"><?php _e('Animation', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <select name="animation" id="animation">
            <option value="slide" selected="true"><?php _e('Slide', NOO_TEXT_DOMAIN); ?></option>
            <option value="fade"><?php _e('Fade', NOO_TEXT_DOMAIN); ?></option>
          </select>
        </div>
      </div>
      <!-- <div class="noo-form-group">
        <label for="visible_items"><?php _e('Max Number of Visible Items', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="text" id="visible_items" name="visible_items" class="noo-slider" value="1" data-min="1" data-max="10"/>
        </div>
      </div>  -->
      <div class="noo-form-group">
        <label for="slider_time"><?php _e('Slide Time (ms)', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="text" id="slider_time" name="slider_time" class="noo-slider" value="3000" data-min="500" data-max="8000" data-step="100"/>
        </div>
      </div> 
      <div class="noo-form-group">
        <label for="slider_speed"><?php _e('Slide Speed (ms)', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="text" id="slider_speed" name="slider_speed" class="noo-slider" value="600" data-min="100" data-max="3000" data-step="100"/>
        </div>
      </div> 
      <div class="noo-form-group">
        <label for="auto_play"><?php _e('Auto Play Slider', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="checkbox" id="auto_play" name="auto_play"/>
        </div>
      </div>
      <div class="noo-form-group">
        <label for="pause_on_hover"><?php _e('Pause On Hover', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="checkbox" id="pause_on_hover" name="pause_on_hover"/>
        </div>
        <small class="noo-control-desc"><?php _e('If auto play, pause slider when mouse over it?', NOO_TEXT_DOMAIN); ?></small>
      </div>
      <div class="noo-form-group">
        <label for="random"><?php _e('Random Slider', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="checkbox" id="random" name="random"/>
        </div>
        <small class="noo-control-desc"><?php _e('Random Choose Slide to Start', NOO_TEXT_DOMAIN); ?></small>
      </div>
      <div class="noo-form-group">
        <label for="indicator"><?php _e('Show Slide Indicator', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
      ...
      <div class="noo-form-group indicator-child" style="display:none;">
        <label for="indicator_position"><?php _e('Indicator Position', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <select type="checkbox" id="indicator_position" name="indicator_position">
            <option value="top" selected="true"><?php _e('Top', NOO_TEXT_DOMAIN); ?></option>
            <option value="bottom" selected="true"><?php _e('Bottom', NOO_TEXT_DOMAIN); ?></option>
          </select>
        </div>
      </div>
      <div class="noo-form-group">
        <label for="prev_next_control"><?php _e('Show Previous/Next Navigation', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="checkbox" id="prev_next_control" name="prev_next_control"/>
        </div>
      </div>
      <div class="noo-form-group">
        <label for="timer"><?php _e('Show Timer', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">
          <input type="checkbox" id="timer" name="timer"/>
        </div>
      </div>
      <div class="noo-form-group">
        <label for="swipe"><?php _e('Enable Swipe on Mobile', NOO_TEXT_DOMAIN); ?></label>
        <div class="noo-control">

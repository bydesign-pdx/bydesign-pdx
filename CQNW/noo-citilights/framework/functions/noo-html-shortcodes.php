				...
				<div class="masonry-header">
					<div class="masonry-filters">
						<ul data-option-key="filter" >
							<li>
								<a class="selected" href="#" data-option-value= "*"><?php echo __('All',NOO_TEXT_DOMAIN) ?></a>
							</li>
							<?php
						...
						<header class="content-header">
							<?php if($post_format=='quote'):?>
								...
								<h2 class="content-title content-quote">
									<a href="<?php the_permalink(); ?>" title="<?php echo esc_attr(sprintf(__('Permanent link to: "%s"', NOO_TEXT_DOMAIN) , the_title_attribute('echo=0'))); ?>">
										<?php echo $quote; ?>
									</a>
								</h2>
							...
							<?php else:?>
								...
								<?php if($post_format == 'link'):?>
									...
									<span class="content-sub-title content-link">
										<a href="<?php echo $link; ?>" title="<?php echo esc_attr( sprintf( __( 'Shared link from post: "%s"', NOO_TEXT_DOMAIN ), the_title_attribute( 'echo=0' ) ) ); ?>" target="_blank">

...
$topbar_login_page = !empty( $topbar_login_page ) ? add_query_arg('redirect_to', urlencode($current_url), $topbar_login_page) : wp_login_url($current_url);
	...
	<div class="topbar-inner <?php echo $topbar_layout; ?> container-boxed max">
		...
		<?php if ( $topbar_content == 'menu' ) : // Top Menu ?>
			...
			<?php if ( has_nav_menu( 'top-menu' ) ) :
				wp_nav_menu( array(
					...
					echo '<ul class="noo-menu"><li><a href="' . home_url( '/' ) . 'wp-admin/nav-menus.php">' . __( 'Assign a menu', NOO_TEXT_DOMAIN ) . '</a></li></ul>';
				endif; ?>
			</div>
		<?php elseif( $topbar_content == 'html' ) : // HTML content ?>
			...
			<ul class="topbar-content">
				...
				<li class="noo-li-icon"><a href="mailto:<?php echo $topbar_email; ?>"><i class="fa fa-envelope-o"></i>&nbsp;<?php echo __('Email:', NOO_TEXT_DOMAIN) . $topbar_email; ?></a></li>
				<?php endif; ?>
				<?php if( !empty($topbar_show_register) || !empty($topbar_show_login) ) : ?>
					<?php if( !is_user_logged_in() ) : ?>
						<?php if( !empty($topbar_show_register) ) : ?>
						<li class="noo-li-icon"><a href="<?php echo $topbar_register_page; ?>"><i class="fa fa-key"></i>&nbsp;<?php echo __('Register', NOO_TEXT_DOMAIN); ?></a></li>
						<?php endif; ?>
						<?php if( !empty($topbar_show_login) ) : ?>
						<li class="noo-li-icon"><a href="<?php echo $topbar_login_page; ?>"><i class="fa fa-sign-in"></i>&nbsp;<?php echo __('Login', NOO_TEXT_DOMAIN); ?></a></li>
						<?php endif; ?>
					<?php else : ?>
						<li class="noo-li-icon"><a href="<?php echo $topbar_logout_url; ?>"><i class="fa fa-sign-out"></i>&nbsp;<?php echo __('Logout', NOO_TEXT_DOMAIN); ?></a></li>
					<?php endif; ?>
				<?php endif; ?>
			</ul>

			...
			<div class="noo-navbar">
				<div class="navbar-header">
					...
					<a class="navbar-toggle collapsed" data-toggle="collapse" data-target=".noo-navbar-collapse">
						<span class="sr-only"><?php echo __( 'Navigation', NOO_TEXT_DOMAIN ); ?></span>
				...
				<div class="calling-info">
					<div class="calling-content">
						...
						<div class="calling-desc">
							<?php _e('CALL  US  NOW', NOO_TEXT_DOMAIN); ?><br>
		        ...
		        if ( is_one_page_enabled() ) {
					...
					if ( has_nav_menu( 'primary' ) ) :
						...
						echo '<ul class="navbar-nav nav"><li><a href="' . home_url( '/' ) . 'wp-admin/nav-menus.php">' . __( 'No menu assigned!', NOO_TEXT_DOMAIN ) . '</a></li></ul>';
					endif;
		        }
				?>
				</nav> <!-- /.navbar-collapse -->

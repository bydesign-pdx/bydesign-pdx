...
class NooPropertyFeaturedWidget extends WP_Widget{
	public function __construct() {
		parent::__construct (
					...
					__('Recent Properties',NOO_TEXT_DOMAIN), 		    // Name
					array ('description' => __ ( 'Display Widget Recent Properties', NOO_TEXT_DOMAIN ) )
					);
	}
						...
						<span class="featured-status">
							...
							if($terms && !is_wp_error($terms)){
								foreach ( $terms as $term ) {
									...
									if ( is_wp_error( $link ) )
										continue;
									echo '<a href="' . esc_url( $link ) . '">' .sprintf(__('For %s',NOO_TEXT_DOMAIN), $term->name ). '</a>';
									break;
								}
							}
							?>
	...
	public function form( $instance ) {
		...
		?>
		<p><label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:',NOO_TEXT_DOMAIN); ?> <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>" /></label></p>
		<p><label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Number:',NOO_TEXT_DOMAIN); ?> <input class="widefat" id="<?php echo $this->get_field_id('number'); ?>" name="<?php echo $this->get_field_name('number'); ?>" type="text" value="<?php echo esc_attr($number); ?>" /></label></p>
		<p>
			<label for="<?php echo $this->get_field_id('show'); ?>"><?php _e('Show:',NOO_TEXT_DOMAIN); ?> 
				<select id="<?php echo $this->get_field_id('show'); ?>" name="<?php echo $this->get_field_name('show'); ?>">
					<option value="all" <?php selected($show,'all')?>><?php _e('All',NOO_TEXT_DOMAIN)?></option>
					<option value="featured" <?php selected($show,'featured')?>><?php _e('Featured',NOO_TEXT_DOMAIN)?></option>
				</select>
			</label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('category'); ?>"><?php _e('Type (do not select to show all)',NOO_TEXT_DOMAIN); ?></label><br/>
		...
		<p>
			<label for="<?php echo $this->get_field_id('status'); ?>"><?php _e('Status (do not select to show all)',NOO_TEXT_DOMAIN); ?></label><br/>
		...
		<p>
			<label for="<?php echo $this->get_field_id('label'); ?>"><?php _e('Label (do not select to show all)',NOO_TEXT_DOMAIN); ?></label><br/>
		...
		<p>
			<label for="<?php echo $this->get_field_id('location'); ?>"><?php _e('Location (do not select to show all)',NOO_TEXT_DOMAIN); ?></label><br/>
		...
		<p>
			<label for="<?php echo $this->get_field_id('sub_location'); ?>"><?php _e('Sub-Location (do not select to show all)',NOO_TEXT_DOMAIN); ?></label><br/>
...
class NooPropertyAdvancedSearchWidget extends WP_Widget {
	public function __construct() {
		parent::__construct (
					...
					__('Advanced Search Property',NOO_TEXT_DOMAIN), 		// Name
					array ('description' => __ ( 'Display Advanced Search Property', NOO_TEXT_DOMAIN ) )
					);
	}
	public function widget($args, $instance) {
		$title = apply_filters( 'widget_title', empty( $instance['title'] ) ? '' : $instance['title'], $instance, $this->id_base );
		...
		NooProperty::advanced_map(false,__('Search', NOO_TEXT_DOMAIN),false,'search-vertical');
...
class NooSinglePropertyWidget extends  WP_Widget {
	public function __construct() {
		parent::__construct (
			...
			__('Single Property',NOO_TEXT_DOMAIN), 		// Name
			array ('description' => __ ( 'Display Single Property', NOO_TEXT_DOMAIN ) )
		);
	}
	public function widget($args, $instance) {
		$title = apply_filters( 'widget_title', empty( $instance['title'] ) ? '' : $instance['title'], $instance, $this->id_base );
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:',NOO_TEXT_DOMAIN); ?>
				<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
			</label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('property_id'); ?>"><?php _e('Property:',NOO_TEXT_DOMAIN); ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('display_type'); ?>"><?php _e('Display Type:',NOO_TEXT_DOMAIN); ?>
				<select id="<?php echo $this->get_field_id('display_type'); ?>" name="<?php echo $this->get_field_name('display_type'); ?>">
					<?php foreach (array('grid'=>__('Grid',NOO_TEXT_DOMAIN),'list'=>__('List',NOO_TEXT_DOMAIN)) as $k=>$v):?>

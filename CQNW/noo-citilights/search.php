...
$title = __('Properties matching your search', NOO_TEXT_DOMAIN);
?>
<?php get_header(); ?>
	...
	<div class="main-content container-boxed max offset">
		...
		<div class="row">
			...
			<div class="<?php noo_main_class(); ?> <?php noo_page_class(); ?>" role="main">
				<h1><?php _e('Results For', NOO_TEXT_DOMAIN); ?><span>"<?php the_search_query(); ?>"</span></h1>
				...
				<div id="search-results">
					...
					<?php if(have_posts()) : while(have_posts()) : the_post(); ?>
							...
							<?php if( get_post_type($post->ID) == 'post' ){ ?>
								<article class="result">
									...
									<h2 class="title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a> <small><?php echo __('Blog Post', NOO_TEXT_DOMAIN); ?></small></h2>
							...
							<?php }
								...
								<article class="result">
									<h2 class="title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a> <small><?php echo __('Page', NOO_TEXT_DOMAIN); ?></small></h2>	
							...
							<?php }
								...
								<article class="result">
									...
									<h2 class="title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a> <small><?php echo __('Product', NOO_TEXT_DOMAIN); ?></small></h2>	
									<?php if(get_the_excerpt()) the_excerpt(); ?>
									<hr/>
								</article><!--/search-result-->	
							<?php } else if( get_post_type($post->ID) == 'noo_property' ){ ?>
								<article class="result">
									...
									<h2 class="title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a> <small><?php echo __('Property', NOO_TEXT_DOMAIN); ?></small></h2>	
									<?php if(get_the_excerpt()) the_excerpt(); ?>
									<hr/>
								</article><!--/search-result-->	
							<?php } else { ?>
					...
					else: echo "<p>" . __('No results found', NOO_TEXT_DOMAIN) . "</p>"; endif;?>
